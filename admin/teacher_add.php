                    ...
                    <div class="p-6 sm:p-8">
                        ...
                        <form action="teacher_add_action.php" method="POST" class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="first_name" autofocus name="first_name" required
                            ...
                            <!-- Username -->
                            <div>
                                <label for="username" class="block text-gray-700 font-medium mb-2 text-sm sm:text-base">
                                    نام کاربری
                                    <span class="text-red-500">*</span>
                                </label>
                            ...
                            <div class="flex flex-col sm:flex-row gap-3 pt-4">
                                <button type="submit"
                                    class="flex-1 px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors duration-200 text-sm sm:text-base">
                                    افزودن دبیر </button>
                                <a href="teachers.php"
                                    class="flex-1 px-6 py-3 bg-gray-200 text-gray-700 font-medium rounded-lg hover:bg-gray-300 transition-colors duration-200 text-center text-sm sm:text-base">
                                    بازگشت به لیست دبیران </a>
                            </div>
                        </form>
                    </div>
                </div>
