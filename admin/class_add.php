        ...
        <div class="w-full min-h-screen py-8 px-4 sm:px-6 lg:px-8">
            <div class="max-w-2xl mx-auto">
                        ...
                        <form action="class_add_action.php" method="post" class="space-y-6">
                            ...
                            <div>
                                <label for="class_name"
                                    class="block text-gray-700 font-medium mb-2 text-sm sm:text-base"> نام کلاس
                            ...
                            <!-- Action Buttons -->
                            <div class="flex flex-col sm:flex-row gap-3 pt-4"><button type="submit"
                                    ...
                                    ثبت کلاس </button> <a href="classes.php"
                ...
                <div class="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <p class="text-blue-800 text-xs sm:text-sm">💡 نام کلاس باید واضح و قابل تشخیص باشد تا مدیریت
                        دانش‌آموزان آسان‌تر شود.</p>
                </div>
            </div>
        </div>
    </div>
