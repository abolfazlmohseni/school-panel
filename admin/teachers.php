                                ...
                                <thead class="bg-gray-50 border-b-2 border-gray-200">
                                    <tr>
                                        ...
                                        <th
                                            ...
                                            نام کاربری</th>
                                        <th
                                            class="px-4 py-3 text-right text-xs sm:text-sm font-semibold text-gray-700 whitespace-nowrap hidden sm:table-cell">
                                            تاریخ ایجاد</th>
                                        <th
                                ...
                                <tbody class="divide-y divide-gray-200">
                                    <?php while ($row = $res->fetch_assoc()): ?>
                                        <tr class="hover:bg-gray-50 transition-colors duration-150"
                                            ...
                                            <td
                                                class="px-4 py-3 text-xs sm:text-sm text-gray-500 whitespace-nowrap hidden sm:table-cell">
